...
#include "Siul2_Port_Ip_BOARD_InitPeripherals_PBcfg.h"
...
/* Check if the files Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_BOARD_InitPeripherals_PBcfg.h are of the same version */
#if (SIUL2_PORT_IP_VENDOR_ID_CFG_H != SIUL2_PORT_IP_VENDOR_ID_BOARD_InitPeripherals_PBCFG_H)
    #error "Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_BOARD_InitPeripherals_PBcfg.h have different vendor IDs"
#endif
/* Check if the files Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_BOARD_InitPeripherals_PBcfg.h are of the same Autosar version */
#if ((SIUL2_PORT_IP_AR_RELEASE_MAJOR_VERSION_CFG_H != SIUL2_PORT_IP_AR_RELEASE_MAJOR_VERSION_BOARD_InitPeripherals_PBCFG_H) ||   \
     (SIUL2_PORT_IP_AR_RELEASE_MINOR_VERSION_CFG_H != SIUL2_PORT_IP_AR_RELEASE_MINOR_VERSION_BOARD_InitPeripherals_PBCFG_H) ||   \
     (SIUL2_PORT_IP_AR_RELEASE_REVISION_VERSION_CFG_H != SIUL2_PORT_IP_AR_RELEASE_REVISION_VERSION_BOARD_InitPeripherals_PBCFG_H) \
    )
    #error "AutoSar Version Numbers of Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_BOARD_InitPeripherals_PBcfg.h are different"
#endif
/* Check if the files Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_BOARD_InitPeripherals_PBcfg.h are of the same software version */
#if ((SIUL2_PORT_IP_SW_MAJOR_VERSION_CFG_H != SIUL2_PORT_IP_SW_MAJOR_VERSION_BOARD_InitPeripherals_PBCFG_H) || \
     (SIUL2_PORT_IP_SW_MINOR_VERSION_CFG_H != SIUL2_PORT_IP_SW_MINOR_VERSION_BOARD_InitPeripherals_PBCFG_H) || \
     (SIUL2_PORT_IP_SW_PATCH_VERSION_CFG_H != SIUL2_PORT_IP_SW_PATCH_VERSION_BOARD_InitPeripherals_PBCFG_H)     \
    )
    #error "Software Version Numbers of Siul2_Port_Ip_Cfg.h and Siul2_Port_Ip_BOARD_InitPeripherals_PBcfg.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
...
SIUL2_PORT_CONFIG_BOARD_InitPeripherals_PB \
