...
#define CDD_MCL_BOARD_InitPeripherals_PBCFG_AR_RELEASE_MINOR_VERSION_C      7
#define CDD_MCL_BOARD_InitPeripherals_PBCFG_AR_RELEASE_REVISION_VERSION_C   0
#define CDD_MCL_BOARD_InitPeripherals_PBCFG_SW_MAJOR_VERSION_C              3
#define CDD_MCL_BOARD_InitPeripherals_PBCFG_SW_MINOR_VERSION_C              0
#define CDD_MCL_BOARD_InitPeripherals_PBCFG_SW_PATCH_VERSION_C              0
...
const Mcl_ConfigType Mcl_Config =
{
	...
	NULL_PTR,
	NULL_PTR,
	&Flexio_Ip_xFlexioInit_BOARD_INITPERIPHERALS,
};
