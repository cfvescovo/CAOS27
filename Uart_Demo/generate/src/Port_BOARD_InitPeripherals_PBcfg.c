...
static const Port_Siul2_PinConfigType Port_aUsedPinConfigs_BOARD_InitPeripherals[PORT_MAX_CONFIGURED_PADS_U16] =
{
    ...
    { (uint16)96, (uint32)0x00200006, (uint8)PORT_SIUL2_0_U8, (uint8)0, PORT_PIN_OUT, (boolean)FALSE, (boolean)FALSE, (boolean)TRUE, (boolean)FALSE, 65535 },
    { (uint16)97, (uint32)0x00080000, (uint8)PORT_SIUL2_0_U8, (uint8)0, PORT_PIN_IN, (boolean)FALSE, (boolean)FALSE, (boolean)TRUE, (boolean)TRUE, 153 },
