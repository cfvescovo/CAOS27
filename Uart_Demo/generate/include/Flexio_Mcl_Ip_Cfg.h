...
==================================================================================================*/
/* Logic Channel 0 */
#define MclConf_FlexioMclLogicChannels_Flexio_Tx      ((uint32)CHANNEL_0)
/* Logic Channel 1 */
#define MclConf_FlexioMclLogicChannels_Flexio_Rx      ((uint32)CHANNEL_1)
/* Flexio instance configuration. */
extern const Flexio_Ip_InstanceConfigType Flexio_Ip_xFlexioInit_BOARD_INITPERIPHERALS;
