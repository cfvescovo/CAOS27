...
#include "Mcu_BOARD_InitPeripherals_PBcfg.h"
...
/* Check if header file and Mcu_BOARD_InitPeripherals_PBcfg.h file are of the same vendor */
#if (MCU_CFG_VENDOR_ID != MCU_BOARD_INITPERIPHERALS_PBCFG_VENDOR_ID)
    #error "Mcu_Cfg.h and Mcu_BOARD_InitPeripherals_PBcfg.h have different vendor ids"
#endif
/* Check if header file and Mcu_BOARD_InitPeripherals_PBcfg.h file are of the same Autosar version */
#if ((MCU_CFG_AR_RELEASE_MAJOR_VERSION != MCU_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (MCU_CFG_AR_RELEASE_MINOR_VERSION != MCU_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (MCU_CFG_AR_RELEASE_REVISION_VERSION != MCU_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mcu_Cfg.h and Mcu_BOARD_InitPeripherals_PBcfg.h are different"
#endif
/* Check if header file and Mcu_BOARD_InitPeripherals_PBcfg.h file are of the same Software version */
#if ((MCU_CFG_SW_MAJOR_VERSION != MCU_BOARD_INITPERIPHERALS_PBCFG_SW_MAJOR_VERSION) || \
     (MCU_CFG_SW_MINOR_VERSION != MCU_BOARD_INITPERIPHERALS_PBCFG_SW_MINOR_VERSION) || \
     (MCU_CFG_SW_PATCH_VERSION != MCU_BOARD_INITPERIPHERALS_PBCFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Mcu_Cfg.h and Mcu_BOARD_InitPeripherals_PBcfg.h are different"
#endif
...
*/
#define MCU_CGM_0_NUMBER_OF_CLK_MUX        ((uint8)14U)
