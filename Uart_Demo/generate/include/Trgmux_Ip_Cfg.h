...
#if (TRGMUX_IP_CFG_VENDOR_ID != TRGMUX_IP_BOARD_INITPERIPHERALS_PBCFG_VENDOR_ID)
...
#if ((TRGMUX_IP_CFG_AR_RELEASE_MAJOR_VERSION != TRGMUX_IP_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (TRGMUX_IP_CFG_AR_RELEASE_MINOR_VERSION != TRGMUX_IP_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (TRGMUX_IP_CFG_AR_RELEASE_REVISION_VERSION != TRGMUX_IP_BOARD_INITPERIPHERALS_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
...
#if ((TRGMUX_IP_CFG_SW_MAJOR_VERSION != TRGMUX_IP_BOARD_INITPERIPHERALS_PBCFG_SW_MAJOR_VERSION) || \
     (TRGMUX_IP_CFG_SW_MINOR_VERSION != TRGMUX_IP_BOARD_INITPERIPHERALS_PBCFG_SW_MINOR_VERSION) || \
     (TRGMUX_IP_CFG_SW_PATCH_VERSION != TRGMUX_IP_BOARD_INITPERIPHERALS_PBCFG_SW_PATCH_VERSION) \
    )
