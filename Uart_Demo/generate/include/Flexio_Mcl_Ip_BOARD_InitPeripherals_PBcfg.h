...
#ifndef FLEXIO_MCL_IP_PBCFG_BOARD_INITPERIPHERALS_H
#define FLEXIO_MCL_IP_PBCFG_BOARD_INITPERIPHERALS_H
...
#define FLEXIO_MCL_IP_BOARD_INITPERIPHERALS_PBCFG_SW_MAJOR_VERSION              3
