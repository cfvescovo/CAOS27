...
#define DMA_IP_NOF_CFG_LOGIC_CHANNELS   ((uint32)3U)
...
#define DMA_LOGIC_CH_1_NOF_CFG_SGA_ELEMENTS       3

#define DMA_LOGIC_CH_1_SGA_ELEMENT_0    ((uint32)0U)

#define DMA_LOGIC_CH_1_SGA_ELEMENT_1    ((uint32)1U)

#define DMA_LOGIC_CH_1_SGA_ELEMENT_2    ((uint32)2U)
